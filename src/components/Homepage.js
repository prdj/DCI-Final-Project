    ...
    <div className="homepage">
      <section className="numberOne">
        <div className="left">
          <h1>Easy Keys</h1>
          <p>
            We have realized how important it is to have an Easy and creative
            way to expand our experiences.
          </p>
        </div>
      ...
      <section className="numberTwo">
        ...
        <div className="left">
          ...
          <p>
            EasyKeys is a Web browser Music-Keyboard more powerful than you
